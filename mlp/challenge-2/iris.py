...
# nn.fit(data, labels, epochs=10000)
# 
...
# 
# nn.plot_decision_regions(data, labels, nn)
...
# Load dataset
with open('../../knn/challenge-2/iris.csv') as csvfile:
...
alfa = 0.005
epoch = 400
neuron = [4, 50, 3]  # number of neuron each layer
